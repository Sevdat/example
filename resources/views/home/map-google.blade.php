...
<body class="fix-header">
    ...
    <script src="{{ asset('static/plugins/bower_components/gmaps/gmaps.min.js') }}"></script>
    <script src="{{ asset('static/plugins/bower_components/gmaps/jquery.gmaps.js') }}"></script>
</body>
